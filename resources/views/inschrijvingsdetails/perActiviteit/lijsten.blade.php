    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-2">
                ...
                <div>
                    <h3 class="font-semibold text-lg text-gray-800 leading-tight">Ingeschreven kinderen: toon alle ingeschreven kinderen</h3>
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder - afhalen - alleennaarhuis - foto</p>
                    <button
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-2">
                ...
                <div>
                    <h3 class="font-semibold text-lg text-gray-800 leading-tight">Lijst ingeschreven kinderen met contactgegevens</h3>
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder: telefoonnummer - extra contactpersoon</p>
                    <button
                        class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-4">
                ...
                <div>
                    <h3 class="font-semibold text-lg text-gray-800 leading-tight">Aanwezige kinderen: toon enkel ingecheckte kinderen die nog niet uitgechecked zijn</h3>
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder - afhalen - alleennaarhuis - foto</p>
                    <button
                        class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-4">
                ...
                <div>
                    ...
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - optie - afhalen - alleennaarhuis - foto</p>
                    <button
                        class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-4">
                ...
                <div>
                    ...
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder - telefoonnummer ouder - contactpersoon - allergie - beperking - medicatie</p>
                    <button
                        class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-2 gap-4 gap-y-2 text-sm mt-4">
                    ...
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder - telefoonnummer ouder - contactpersoon - allergie</p>
                        <button
                            class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
                    ...
                    <p class="text-md text-gray-800 leading-tight">voornaam - familienaam - leerjaar - ouder - telefoonnummer ouder - contactpersoon - medicatie</p>
                            <button
                                class="rounded-md bg-gray-500 text-white focus:ring-gray-600 px-2 py-2 text-sm"
