<x-app-layout>
    <form method="POST" action="{{ route('kinderen.store') }}">
        @csrf

        <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">

                <h2 class="font-semibold text-xl text-gray-600">Nieuw kind toevoegen</h2>
                <p class="text-gray-500 mb-6">Vul hieronder de gegevens aan van je kind</p>
                                ...
                                <p>Gelieve alle velden in te vullen</p>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <input type="text" name="voornaam" id="voornaam"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('voornaam') }}"
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <input type="text" name="familienaam" id="familienaam"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('familienaam') }}"
                                    ...
                                    <div class="md:col-span-3">
                                        ...
                                        <input type="text" name="rijksregisternummer" id="rijksregisternummer"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('rijksregisternummer') }}"
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="allergie" id="allergie"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('allergie') }}"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="beperking" id="beperking"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('beperking') }}"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="medicatie" id="medicatie"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('medicatie') }}"
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="contactpersoon" id="contactpersoon"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('contactpersoon') }}"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="afhalenKind" id="afhalenKind"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('afhalenKind') }}"
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="uitpasnummer" id="uitpasnummer"
                                               class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('uitpasnummer') }}"
